...
Plans record how an accepted initiative is executed; handovers under
`docs/agent/handovers/` record ownership and phase transitions; GitHub issues,
pull requests, and Git remain the source of truth for volatile work state.
