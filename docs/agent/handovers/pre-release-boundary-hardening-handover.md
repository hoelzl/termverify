...
The owner accepted slice 2 on 2026-07-19 (issue #143, PR #144), completing
the workstream: `tests/test_conpty_integration.py` carries the durable
...
merged; further key-input work (an extended encoding version, POSIX,
