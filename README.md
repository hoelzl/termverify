...
remains authoritative — that authoritative codec, and the key registries'
entry points, are exported from `termverify` alongside the schema accessors. A strict no-regression coverage floor gates the full
